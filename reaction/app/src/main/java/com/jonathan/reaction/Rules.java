...
public class Rules extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (language.equals("French"))
        {
            ...
            staminaR.setText("Dès que l'écran passe vert, appuityez sur l'écran avant qui'il ne devienne bleu ! Faites le le plus vite possible, vous n'aurez que 3 vies !");
        }
